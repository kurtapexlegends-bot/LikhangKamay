    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'port' => env('MYSQL_PORT', env('DB_CONNECTION') === 'pgsql' ? '3306' : env('DB_PORT', '3306')),
            'database' => env('MYSQL_DATABASE', env('DB_CONNECTION') === 'pgsql' ? 'likhangkamay' : env('DB_DATABASE', 'laravel')),
            'username' => env('MYSQL_USERNAME', env('DB_CONNECTION') === 'pgsql' ? 'root' : env('DB_USERNAME', 'root')),
            'password' => env('MYSQL_PASSWORD', env('DB_CONNECTION') === 'pgsql' ? '' : env('DB_PASSWORD', '')),
