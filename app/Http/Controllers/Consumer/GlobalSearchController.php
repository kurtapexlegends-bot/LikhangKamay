...
class GlobalSearchController extends Controller
{
    ...
    private function searchSellerNavigationAndSettings(User $user, string $query, string $like): array
    {
        ...
        $navItems = [
            ...
            [
                'keywords' => ['people & payroll', 'people', 'payroll rates', 'basic pay', 'basic salary', 'daily wage', 'hourly wage', 'overtime multiplier', 'standard workday', 'rest day ot', 'holiday ot', 'inactivity threshold'],
            ...
            [
                'keywords' => ['subscription', 'billing', 'plan', 'elite plan', 'active products limit', 'upgrade'],
