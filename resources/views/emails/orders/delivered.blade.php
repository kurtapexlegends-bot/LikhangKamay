...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; margin: 0; padding: 0; background-color: #FDFBF9; color: #2E2520; line-height: 1.6; -webkit-text-size-adjust: none;">
    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border: 1px solid #E7E1D8; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 12px rgba(46, 37, 32, 0.03);">
        ...
        <div style="padding: 40px 32px;">
            <h1 style="font-family: Georgia, Times, serif; font-size: 24px; font-weight: normal; color: #A2582F; margin-top: 0; margin-bottom: 8px; text-align: center;">Order Delivered!</h1>
            <div style="text-align: center;">
                <span style="display: inline-block; background-color: #F7F4F0; border: 1px solid #E7E1D8; color: #A2582F; padding: 6px 14px; border-radius: 20px; font-size: 13px; font-weight: 600; margin: 12px 0 24px;">Completed</span>
            </div>

            <p style="margin-top: 0; margin-bottom: 16px; font-size: 15px; color: #5C524A; line-height: 1.6;">Hello {{ $order->customer_name }},</p>
            <p style="margin-top: 0; margin-bottom: 16px; font-size: 15px; color: #5C524A; line-height: 1.6;">Great news! You have marked your order as <strong>received</strong>. We hope you love your handcrafted items!</p>
            ...
            <div style="background-color: #FFFDFB; border: 1px solid #E7E1D8; border-radius: 8px; padding: 24px; margin: 24px 0;">
                ...
                <p style="color: #8C827A; font-size: 13px; margin-top: -8px; margin-bottom: 16px;">
                    Received: {{ $order->received_at ? $order->received_at->format('F d, Y • h:i A') : now()->format('F d, Y • h:i A') }}
                </p>
            ...
            <div style="background-color: #F7F4F0; border-left: 3px solid #C2783F; padding: 16px; margin: 24px 0; border-radius: 0 8px 8px 0; font-size: 13px; color: #7C6D62; line-height: 1.5;">
            ...
            <p style="margin-top: 24px; text-align: center; font-size: 15px; color: #5C524A;">We'd love to hear your feedback! Consider leaving a review for the products you purchased.</p>

            <div style="text-align: center; margin-top: 24px;">
                <a href="{{ url('/my-orders') }}" style="display: inline-block; background-color: #C2783F; color: #ffffff !important; text-decoration: none; font-weight: 600; font-size: 14px; padding: 12px 28px; border-radius: 8px; text-align: center;">View My Orders</a>
            </div>
        </div>
        <div style="background-color: #F7F4F0; border-top: 1px solid #E7E1D8; padding: 28px; text-align: center; font-size: 12px; color: #8C827A; line-height: 1.5;">
            <p style="margin: 0;">Thank you for supporting Filipino artisans!</p>
