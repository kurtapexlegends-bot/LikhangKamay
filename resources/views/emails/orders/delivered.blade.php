...
<head>
    ...
    <style>
        ...
        .warning { background: #fef3c7; border-radius: 8px; padding: 12px; margin: 16px 0; font-size: 14px; color: #92400e; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <p>Great news! You've marked your order as <strong>received</strong>. We hope you love your handcrafted items!</p>

        <div class="order-box">
            <div class="order-number">Order #{{ $order->order_number }}</div>
            <p style="color: #6b7280; font-size: 14px;">Received: {{ $order->received_at ? $order->received_at->format('F d, Y • h:i A') : now()->format('F d, Y • h:i A') }}</p>
        ...
        <div style="text-align: center;">
            <a href="{{ url('/my-orders') }}" class="cta">View My Orders →</a>
        </div>
