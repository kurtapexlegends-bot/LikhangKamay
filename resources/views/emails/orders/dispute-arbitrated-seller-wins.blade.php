...
<head>
    <meta charset="utf-8">
    <title>Dispute Arbitration Update</title>
</head>
    ...
    <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border: 1px solid #E7E1D8; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 12px rgba(46, 37, 32, 0.03);">
        ...
        <div style="padding: 40px 32px;">
            ...
            <p style="margin-top: 0; margin-bottom: 24px; font-size: 16px; color: #5C524A; line-height: 1.6;">
                The platform administrators have arbitrated your escalated dispute for Order <strong>#{{ $orderNumber }}</strong> and ruled in favor of the seller.
            </p>
            @if($notes)
                <div style="background-color: #F7F4F0; border: 1px solid #E7E1D8; border-radius: 8px; padding: 16px 20px; margin-bottom: 24px; font-size: 14px; color: #5C524A; line-height: 1.5;">
                    <strong style="color: #2E2520; display: block; margin-bottom: 4px;">Arbitrator Decision Details:</strong>
                    {{ $notes }}
                </div>
            @endif
            <div style="text-align: center; margin-top: 30px;">
                <a href="{{ route('my-orders.index') }}" style="display: inline-block; background-color: #A2582F; color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none; padding: 12px 28px; border-radius: 6px; letter-spacing: 0.5px;">View My Orders</a>
            </div>
        </div>
