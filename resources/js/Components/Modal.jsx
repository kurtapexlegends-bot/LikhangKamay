    ...
    return (
        <Transition show={show} leave="duration-200" afterLeave={afterLeave}>
            ...
            >
                ...
                >
                    <DialogPanel
                        className={`transform overflow-y-auto rounded-lg bg-white shadow-xl transition-all max-h-[calc(100vh-1.5rem)] sm:mx-auto sm:w-full sm:max-h-[calc(100vh-2rem)] ${maxWidthClass}`}
                    >
                        {children}
                    </DialogPanel>
                </TransitionChild>
