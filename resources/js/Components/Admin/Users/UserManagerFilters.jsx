                ...
                <div className="rounded-2xl border border-stone-200 bg-white shadow-sm px-4 py-3 sm:px-6">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="text-xs font-medium text-stone-505">
                ...
                <div className="relative w-full sm:w-72">
                    ...
                    {searchQuery && (
                        <button
                            ...
                            className="absolute right-3 top-1/2 -translate-y-1/2 rounded p-1 text-stone-400 transition-colors hover:text-stone-600 min-h-[36px] min-w-[36px] flex items-center justify-center"
