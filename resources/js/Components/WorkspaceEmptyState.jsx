...
export default function WorkspaceEmptyState({
    ...
    return (
        <div className={`relative overflow-hidden rounded-3xl border border-dashed border-stone-200 bg-stone-50/50 flex flex-col items-center justify-center text-center ${compact ? 'px-6 py-12' : 'px-8 py-20'}`}>
