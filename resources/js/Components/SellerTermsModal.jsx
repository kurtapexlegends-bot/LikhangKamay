...
export default function SellerTermsModal({ show, onClose }) {
    return (
        <Modal show={show} onClose={onClose} maxWidth="2xl">
            {/* Modal Content */}
            <div className="bg-[#FAF7F2] max-h-[85vh] flex flex-col">
                {/* Header */}
                <div className="px-6 py-4 border-b border-stone-200/60 flex justify-between items-center bg-[#FAF7F2]">
                    <h3 className="text-lg font-serif font-bold text-stone-900">Artisan Seller Agreement</h3>
                ...
                <div className="p-6 overflow-y-auto text-sm text-stone-600 leading-relaxed space-y-6">
                    <p className="font-bold text-stone-900">Last Updated: January 4, 2026</p>
                ...
                {/* Footer Actions */}
                <div className="px-6 py-4 bg-[#FCFBF9] border-t border-stone-200/60 flex justify-end gap-3">
