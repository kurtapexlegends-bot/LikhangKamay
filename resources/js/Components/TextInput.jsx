...
export default forwardRef(function TextInput(
    ...
    return (
        <input
            ...
            type={type}
            className={
                `rounded-xl shadow-sm transition-all duration-500 outline-none disabled:bg-stone-100 disabled:text-stone-500 disabled:border-stone-200 disabled:shadow-none disabled:cursor-not-allowed ${
                    hasError 
