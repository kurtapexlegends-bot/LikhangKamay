...
const hoverTextToneMap = {
    ...
    slate: 'group-hover:text-stone-800',
...
const urgentBadgeToneMap = {
    ...
    emerald: 'bg-emerald-600 text-white border-emerald-700/20 shadow-sm shadow-emerald-600/10',
    ...
    indigo: 'bg-indigo-600 text-white border-indigo-700/20 shadow-sm shadow-indigo-600/10',
                ...
                <div className="flex items-start justify-between gap-2.5">
                    <div className="flex items-center gap-2.5 min-w-0 flex-1 pr-1">
                        ...
                        <div className="min-w-0 flex-1">
                            <h3 className={`text-sm font-bold text-stone-900 transition-colors duration-300 flex items-center gap-1.5 leading-snug ${hoverTextTone}`}>
                                <span className="truncate">{card.title}</span>
                                <ArrowRight size={12} className={`shrink-0 opacity-0 -translate-x-1.5 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ${hoverArrowTone}`} />
                            </h3>
                        </div>
                    </div>

                    {/* Unified Metric Indicator Badge */}
                    <div className={`shrink-0 flex-none inline-flex items-center gap-1.5 rounded-full pl-2.5 pr-1 py-1 text-[8.5px] font-bold uppercase tracking-wider border transition-all duration-300 ${
                        isUrgent
                            ? urgentBadgeTone
                        ...
                        <span className="whitespace-nowrap">{card.metricLabel}</span>
