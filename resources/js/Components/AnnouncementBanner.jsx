...
export default function AnnouncementBanner({ announcement }) {
    ...
    return (
        <div className="fixed top-4 sm:top-6 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-2rem)] max-w-3xl animate-in slide-in-from-top-8 fade-in duration-500 ease-out-expo">
            <div 
            ...
            >
                ...
                {hasTimer && (
                    <div className="absolute bottom-0 left-0 w-full h-[2px] opacity-30 origin-left pointer-events-none">
                        <div 
                            className={`h-full transition-all duration-75 ease-linear ${isCustom ? 'bg-white' : config.progress}`} 
