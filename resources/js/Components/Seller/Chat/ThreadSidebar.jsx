...
import { X, FileIcon, Smile } from 'lucide-react';
                ...
                <div className="p-4 bg-stone-50 border-b border-stone-100 shrink-0 group relative">
                    <div className="flex items-start gap-2.5">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-stone-600 leading-relaxed break-words whitespace-pre-wrap">
                                {renderMessageTextWithMentions(parent.text, auth?.user, !!parent.team_channel_id)}
                            </p>
                                ...
                                <div className="flex flex-col max-w-[82%]">
                                    ...
                                    >
                                        ...
                                        <p className="leading-relaxed break-words whitespace-pre-wrap">
                                            {renderMessageTextWithMentions(reply.text, auth?.user, !!parent.team_channel_id)}
                                        </p>
                                        <span
