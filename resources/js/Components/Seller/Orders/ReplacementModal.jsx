            ...
            <div className="p-6">
                <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Describe the compensation or resolution the
                            buyer will receive.
                        </p>
                    </div>
                </div>

                <div className="rounded-xl border border-teal-100 bg-teal-50 px-4 py-3 text-xs text-teal-800 font-medium">
                    The order will return to the normal delivery lifecycle
                    and must be officially received by the buyer again.
                </div>
                ...
                <div className="mt-4">
                    ...
                    <textarea
                        ...
                        className="w-full rounded-xl border-gray-300 text-sm shadow-sm focus:border-teal-500 focus:ring-teal-500 resize-none"
                ...
                <div className="mt-6 flex justify-end gap-3 border-t border-gray-100 pt-4">
                    <button
                        ...
                        className="rounded-xl border border-gray-200 px-4 py-2 text-sm font-bold text-gray-700 hover:bg-gray-50 disabled:opacity-50 min-h-[44px] flex items-center justify-center"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        disabled={
                            !canEditOrders || replacementModal.processing
                        }
                        className="rounded-xl bg-teal-600 px-5 py-2 text-sm font-bold text-white shadow-lg shadow-teal-200 hover:bg-teal-700 transition disabled:opacity-50 min-h-[44px] flex items-center justify-center"
                    >
