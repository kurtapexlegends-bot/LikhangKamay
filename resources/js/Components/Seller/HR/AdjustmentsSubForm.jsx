            ...
            <div className="space-y-3 bg-stone-50/50 p-3.5 rounded-2xl border border-stone-150">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <div>
                        ...
                        <input
                            type="number"
                            className="w-full rounded-xl border border-red-200 bg-white p-2 text-xs font-bold text-red-900 text-center shadow-none focus:border-red-500 focus:ring-red-500 min-h-[44px]"
                    ...
                    <div>
                        ...
                        <input
                            type="number"
                            className="w-full rounded-xl border border-emerald-200 bg-white p-2 text-xs font-bold text-emerald-900 text-center shadow-none focus:border-emerald-500 focus:ring-emerald-500 min-h-[44px]"
            ...
            <div className="space-y-3 bg-[#FCF7F2]/40 p-3.5 rounded-2xl border border-[#E7D8C9]/60">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                    <div className="col-span-1">
                        ...
                        <input
                            type="number"
                            className="w-full rounded-xl border border-orange-200 bg-white p-2 text-xs font-bold text-orange-900 text-center shadow-none focus:border-orange-500 focus:ring-orange-500 min-h-[44px]"
                    ...
                    <div>
                        ...
                        <input
                            type="number"
                            className="w-full rounded-xl border border-[#E7D8C9] bg-white p-2 text-xs font-bold text-clay-950 text-center shadow-none focus:border-clay-500 focus:ring-clay-500 min-h-[44px]"
