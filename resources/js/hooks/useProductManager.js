...
export default function useProductManager({
    ...
    return {
        ...
        openArchiveModal,
        openDeductModal,
        discountModalOpen: modalsState.discountModalOpen,
        setDiscountModalOpen: modalsState.setDiscountModalOpen,
        discountTargetProducts: modalsState.discountTargetProducts,
        openDiscountModal: modalsState.openDiscountModal,
