                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm font-medium text-stone-700">
                                                                {orderToShip.shipping_contact_phone ||
                                                                    "No phone provided"}
                                                            </p>
                                                        </div>
