...
export default function ProcurementCheckout({ auth, items = [], pricing, userAddresses = [] }) {
    ...
    return (
        <>
            <Head title="Procurement Checkout - Artisan Supply Hub" />
            <SellerHeader
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-1 text-emerald-800 text-xs font-bold shadow-2xs">
                        ...
                        <span>Artisan Studio Sourcing Session</span>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-stone-200 bg-white p-4 text-xs text-stone-700 shadow-2xs flex items-start gap-3">
                    ...
                    <div className="space-y-0.5">
                        <span className="font-bold text-stone-900 block">Automated Closed-Loop Workshop Restock</span>
                        <p className="text-stone-500">
                            Purchased raw materials will be fulfilled by peer artisan studios. When delivery is marked received, LikhangKamay automatically records the items into your <strong className="text-stone-800 font-semibold">Studio Materials Inventory</strong> with weighted-average unit costing.
                        </p>
                    </div>
                </div>
