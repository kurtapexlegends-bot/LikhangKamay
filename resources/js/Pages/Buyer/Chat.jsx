                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-lg overflow-hidden flex h-[calc(100vh-140px)]">
                            ...
                            {filteredContacts.length > 0 ? (
                                filteredContacts.map((contact) => (
                                    <Link 
                                        ...
                                        className={`w-full p-4 flex gap-3 transition-all text-left border-l-4 group ${
                    ...
                    <div className={`flex-1 flex flex-col bg-white ${!showMobileList ? 'block' : 'hidden sm:flex'}`}>
                        {currentChatUser ? (
                            <>
                                {/* Chat Header */}
                                <div className="h-[72px] border-b border-gray-100 flex items-center justify-between px-6 bg-gradient-to-r from-white to-gray-50/50 shrink-0">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="relative">
                                            {currentChatUser.avatar ? (
                                                ...
                                                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-clay-400 to-clay-600 flex items-center justify-center font-bold text-white uppercase shadow-sm">
