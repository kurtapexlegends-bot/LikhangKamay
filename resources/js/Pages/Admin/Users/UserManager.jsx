                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 border-b-2 pb-4 px-1 text-xs sm:text-sm font-bold transition-all whitespace-nowrap outline-none min-h-[44px] ${
                                        activeTab === tab.id
                                            ...
                                            : 'border-transparent text-stone-505 hover:text-stone-700 hover:border-stone-200'
                                    }`}
                                >
                                    <Icon size={16} />
                                    <span>{tab.label}</span>
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="col-span-4 flex items-center gap-4">
                                                                    ...
                                                                    <div className="flex items-center gap-4 min-w-0">
                                                                        ...
                                                                        <div className="min-w-0">
                                                                            ...
                                                                            <p className="text-stone-505 text-[11px] font-medium truncate mt-0.5">{artisan.name}</p>
                                                                ...
                                                                <div className="col-span-2 flex flex-col items-start md:items-center gap-1">
                                                                    <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-widest text-amber-650 bg-amber-50/50 border border-amber-200/30 px-2 py-0.5 rounded-full">
                        ...
                        <div className="rounded-2xl bg-stone-50 p-4 border border-stone-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-stone-505 font-medium">{drawerArtisan.name} • {drawerArtisan.email}</p>
                                </div>
                            </div>
                        </div>
